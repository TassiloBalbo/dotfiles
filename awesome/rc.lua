...
awful.screen.connect_for_each_screen(function(s)
	...
	-- Set Wallpaper
	--gears.wallpaper.fit(gears.filesystem.get_configuration_dir() .. "images/bg.png", s, nil)
	gears.wallpaper.centered(gears.filesystem.get_configuration_dir() .. "images/bg.png", s, yes, nil)
end)
...
awful.rules.rules = {
	...
	}, -- so items in tasklist have the right order
	-- Floating clients.
	{
		rule_any = {
			instance = {
