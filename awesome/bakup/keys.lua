...
globalkeys = my_table.join(
		...
		awful.key({ modkey }, "Print", function() awful.util.spawn_with_shell("scrot -z ~/Pictures/screenshots/%F_%T.png") end,
							{description = "take fullscreen screenshot", group = "hotkeys"}),
    -- Take selection screenshot
    awful.key({ }, "Print", function() awful.util.spawn_with_shell("sleep 0.5 && scrot -z -s -f ~/Pictures/screenshots/%F_%T.png") end,
		...
		-- screen locker
		awful.key({ modkey }, "l", function () os.execute("light-locker-command -l") end,
    ...
    awful.key({ modkey }, "r", function () awful.util.spawn("rofi -show run") end,
		...
		-- Emoji menu
		awful.key({ modkey }, ".", function () awful.util.spawn("rofi -show emoji -modi emoji") end,
